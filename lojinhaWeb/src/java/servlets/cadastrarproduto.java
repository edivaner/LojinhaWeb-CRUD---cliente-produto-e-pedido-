...
public class cadastrarproduto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Produto p = new Produto(request.getParameter("nome"),
      ...
      try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("O produto foi cadastrado com sucesso. <a href=\"ListarProdutos.jsp\">Clique aqui para ir a listagem.</a>");
            out.println("</body>");
            out.println("</html>");
        }
 }
